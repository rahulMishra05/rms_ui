...
function Education() {
	...
	const customFunction = (d) => {
		...
		console.log(EduObj);
		axios.put(`https://localhost:7258/api/Resume/${id}`, EduObj);
					...
					<div className="FormFeilds">
						<div className="labelInputEducation">
							...
							<input {...register(`test.${index}.courseName`)}
                                ...
                                defaultValue={editData.educationDetails===[]?editData.educationDetails[index].courseName:null}/>
						</div>
						<div className="labelInputEducation">
							...
							<input {...register(`test.${index}.specialization`)}
                                ...
                                defaultValue={editData.educationDetails===[]?editData.educationDetails[index].specialization:null}/>
						</div>
						<div className="labelInputEducation">
							...
							<input {...register(`test.${index}.instituteName`)}
                                ...
                                defaultValue={editData.educationDetails===[]?editData.educationDetails[index].instituteName:null} />
						</div>
						<div className="labelInputEducation">
                            ...
                            <input {...register(`test.${index}.university`)}
                                ...
                                defaultValue={editData.educationDetails===[]?editData.educationDetails[index].university:null} />
                        </div>
						<div className="labelInputEducation">
							...
							<input {...register(`test.${index}.passingYear`)}
                                ...
                                defaultValue={editData.educationDetails===[]?editData.educationDetails[index].passingYear:null}/>
						</div>
						<div className="labelInputEducation">
							...
							<input {...register(`test.${index}.marks`)}
                                ...
                                defaultValue={editData.educationDetails===[]?editData.educationDetails[index].marks:null} />
						</div>
