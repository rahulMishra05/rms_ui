...
export default function WorkExp(props) {
  ...
  useEffect(() => {
    fetch('https://localhost:44396/api/DesignationMaster/GetActiveDesignation', {
      method: 'GET',
      headers: {
  ...
  useEffect(() => {
    fetch('https://localhost:44396/api/ProjectMaster/GetActiveProjects', {
      method: 'GET',
      headers: {
        'content-type': 'application/json',
      }
  ...
  useEffect(() => {
    fetch('https://localhost:44396/api/TechStackMaster', {
      method: 'GET',
      headers: {
        'content-type': 'application/json',
      }
  ...
  useEffect(() => {
    fetch('https://localhost:44396/api/TechStackValues/GetActiveTechs', {
      method: 'GET',
      headers: {
        'content-type': 'application/json',
      }
