...
function SidebarEdit(props) {
	...
	return (
		...
		<aside className="sidebar">
			...
			<Link to={`mydetails/Edit/${props.id}`}>
			...
			<Link to={`education/Edit/${props.id}`}>
				<div className="menuDiv">
